                    ...
                    <div className="course-category-two__carousel">
                        ...
                        <div className="item">
                            <div className="course-category-two__single color-1">
                                ...
                                <h3 className="course-category-two__title"><Link to="#">IT & Software</Link></h3>
                            </div>
                        </div>
                        <div className="item">
                            <div className="course-category-two__single color-2">
                                ...
                                <h3 className="course-category-two__title"><Link to="#">Development</Link></h3>
                            </div>
                        </div>
                        <div className="item">
                            <div className="course-category-two__single color-3">
                                ...
                                <h3 className="course-category-two__title"><Link to="#">Music</Link></h3>
                            </div>
                        </div>
                        <div className="item">
                            <div className="course-category-two__single color-4">
                                ...
                                <h3 className="course-category-two__title"><Link to="#">Photography</Link></h3>
                            </div>
                        </div>
                        <div className="item">
                            <div className="course-category-two__single color-5">
                                ...
                                <h3 className="course-category-two__title"><Link to="#">Marketing</Link></h3>
                            </div>
                        </div>
                        <div className="item">
                            <div className="course-category-two__single color-6">
                                ...
                                <h3 className="course-category-two__title"><Link to="#">Health & Fitness</Link></h3>
                            </div>
                        </div>
                        <div className="item">
                            <div className="course-category-two__single color-1">
