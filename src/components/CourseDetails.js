                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="course-details__content">
                            ...
                            <ul className="course-details__tab-navs list-unstyled nav nav-tabs" role="tablist">
                                <li>
                                    <Link className="active" role="tab" data-toggle="tab" to="#overview">Overview</Link>
                                </li>
                                <li>
                                    <Link className="" role="tab" data-toggle="tab" to="#curriculum">Curriculum</Link>
                                </li>
                                <li>
                                    <Link className="" role="tab" data-toggle="tab" to="#review">Reviews</Link>
                                </li>
                            </ul>
                                            ...
                                            <ul className="course-details__curriculum-list list-unstyled">
                                                ...
                                                <li>
                                                    <div className="course-details__curriculum-list-left">
                                                        ...
                                                        <Link to="#">Basic Editing Technology</Link>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div className="course-details__curriculum-list-left">
                                                        ...
                                                        <ul className="course-details__curriculum-list list-unstyled">
                                                            <li>
                                                                <div className="course-details__curriculum-list-left">
                                                                    ...
                                                                    <Link to="#">Introduction to Editing</Link>
                                                                    <span>Preview</span>
                                                                </div>
                                                                <div
                                ...
                                <div className="tab-pane  animated fadeInUp" role="tabpanel" id="review">
                                    ...
                                    <form action="#" className="course-details__comment-form">
                                        <h2 className="course-details__title">Add a
                                            review</h2>
                                        <p className="course-details__comment-form-text">Rate this Course? <Link to="#" className="fas fa-star"></Link>
                    ...
                    <div className="col-lg-4">
                        <div className="course-details__price">
                            ...
                            <Link to="#" className="thm-btn course-details__price-btn">Buy This Course</Link>
                        </div>

                        <div className="course-details__meta">
                            <Link to="#" className="course-details__meta-link">
